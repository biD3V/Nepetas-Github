...
-(void)initializeWaveLayers{
    ...
    self.rWaveLayer = [MSHJelloLayer layer];
    self.subwaveLayer = [MSHJelloLayer layer];
    self.rSubwaveLayer = [MSHJelloLayer layer];
    self.subSubwaveLayer = [MSHJelloLayer layer];
    self.rSubSubwaveLayer = [MSHJelloLayer layer];
...
-(void)updateWaveColor:(UIColor *)waveColor subwaveColor:(UIColor *)subwaveColor subSubwaveColor:(UIColor *)subSubwaveColor{
    ...
    self.rWaveColor = waveColor;
    self.subwaveColor = subwaveColor;
    self.rSubwaveColor = subwaveColor;
    self.subSubwaveColor = subSubwaveColor;
    self.rSubSubwaveColor = subSubwaveColor;
